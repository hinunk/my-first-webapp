...
app.use(
  controller.get("/backet", function*() {
    this.set("Cache-Control", "no-cache");
...
app.use(
  controller.get("/female", function*() {
    this.set("Cache-Control", "no-cache");
...
app.use(
  controller.get("/usercenter", function*() {
    this.set("Cache-Control", "no-cache");
...
app.use(
  controller.get("/category", function*() {
    this.set("Cache-Control", "no-cache");
...
app.use(
  controller.get("/ajax/rank", function*() {
    this.set("Cache-Control", "no-cache");
...
/* 任务代码 */
app.use(
  controller.get("/ajax/male", function*() {
    this.set("Cache-Control", "no-cache");
...
app.use(
  controller.get("/ajax/female", function*() {
    this.set("Cache-Control", "no-cache");
...
app.use(
  controller.get("/ajax/category", function*() {
    this.set("Cache-Control", "no-cache");
